...
const VoteItem = ({ vote, onAddVote, onRemoveVote }) => {
  const addVote_Combine_Animation = (e) => {
    ...
    setInterval(() => {liNode.classList.remove("re-order")}, 1500);
  }
  ...
  return (
      <li className="media my-4" style={orderList}>
        ...
        <div className="media-body">
          ...
          <div className="action">
            ...
            <span className="fas point"><small>{vote.point}</small> <i className="far fa-kiss-wink-heart"></i></span>
